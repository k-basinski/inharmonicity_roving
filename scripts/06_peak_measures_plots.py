...
# %%
measures = ["mmn_mean_amp","mmn_peak_lat",  "p3_mean_amp", "p3_peak_lat"]
...
axs[0][0].set_title("A) MMN Mean Amplitude", loc='left')
axs[1][0].set_title("C) MMN Peak Latency", loc='left')
axs[0][1].set_title("B) P3a Mean Amplitude", loc='left')
axs[1][1].set_title("D) P3a Peak Latency", loc='left')

axs[1][1].set_xlabel(None)
axs[1][0].set_xlabel(None)

axs[0][0].set_ylabel('\u03bcV')
